...
import com.office.qljt.qljtoffice.entity.Article;
...
////        CompletableFuture.supplyAsync(() -> updateArticleViewsCount(articleId));//子线程sseion无法调用报错
//        // 查询上一篇下一篇文章
...
//        String idStr = (String) redisService.get(ipAddress);
//        if(TextUtils.isEmpty(idStr) ) idStr = "";
//        if ( idStr.indexOf("-" + articleId.toString() +"-") < 0) {
//            try {
//                idStr += "-" + articleId+"-";
//                redisService.set(ipAddress, idStr, 600);
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
//            // 浏览量+1
