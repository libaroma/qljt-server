...
import com.office.qljt.qljtoffice.enums.StatusCodeEnum;
import lombok.Data;

import static com.office.qljt.qljtoffice.enums.StatusCodeEnum.*;
...
public class Result<T> {
    ...
    public static <T> Result<T> ok(boolean flag) {
        return flag ? Result.ok() : Result.fail("无权限操作");
    }
