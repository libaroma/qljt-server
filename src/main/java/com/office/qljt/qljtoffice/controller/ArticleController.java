...
import com.office.qljt.qljtoffice.service.ArticleService;
import com.office.qljt.qljtoffice.strategy.context.UploadStrategyContext;
...
//     *
//     * @param file 文件
//     * @return {@link Result<String>} 文章音乐地址
//     */
//    @CheckTooFrequentCommit
//    @ApiOperation(value = "上传文章音乐")
//    @ApiImplicitParam(name = "file", value = "文章音乐", required = true, dataType = "MultipartFile")
//    @PostMapping("/admin/articles/music")
//    public Result<String> saveArticleMusic(MultipartFile file) {
//        return Result.ok(uploadStrategyContext.executeUploadStrategy(file, FilePathEnum.MUSIC.getPath()));
//    }
